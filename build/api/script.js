...
exports.default = (app) => {
    ...
    route.get('/scripts/:file', async (req, res, next) => {
        const logger = typedi_1.Container.get('logger');
        try {
            const content = (0, util_1.getFileContentByName)(`${config_1.default.scriptPath}${req.params.file}`);
    ...
    route.post('/scripts', (0, celebrate_1.celebrate)({
    ...
    route.put('/scripts', (0, celebrate_1.celebrate)({
        body: celebrate_1.Joi.object({
            filename: celebrate_1.Joi.string().required(),
            content: celebrate_1.Joi.string().required(),
        }),
    ...
    route.delete('/scripts', (0, celebrate_1.celebrate)({
        body: celebrate_1.Joi.object({
            filename: celebrate_1.Joi.string().required(),
        }),
    }), async (req, res, next) => {
