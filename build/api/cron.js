...
exports.default = (app) => {
    ...
    route.post('/crons', (0, celebrate_1.celebrate)({
    ...
    route.put('/crons/run', (0, celebrate_1.celebrate)({
    ...
    route.put('/crons/stop', (0, celebrate_1.celebrate)({
        body: celebrate_1.Joi.array().items(celebrate_1.Joi.string().required()),
    }), async (req, res, next) => {
        const logger = typedi_1.Container.get('logger');
        try {
    ...
    route.put('/crons/disable', (0, celebrate_1.celebrate)({
        body: celebrate_1.Joi.array().items(celebrate_1.Joi.string().required()),
    }), async (req, res, next) => {
        const logger = typedi_1.Container.get('logger');
        try {
    ...
    route.put('/crons/enable', (0, celebrate_1.celebrate)({
        body: celebrate_1.Joi.array().items(celebrate_1.Joi.string().required()),
    }), async (req, res, next) => {
        const logger = typedi_1.Container.get('logger');
        try {
    ...
    route.get('/crons/:id/log', (0, celebrate_1.celebrate)({
    ...
    route.put('/crons', (0, celebrate_1.celebrate)({
        body: celebrate_1.Joi.object({
    ...
    route.delete('/crons', (0, celebrate_1.celebrate)({
        body: celebrate_1.Joi.array().items(celebrate_1.Joi.string().required()),
    }), async (req, res, next) => {
        const logger = typedi_1.Container.get('logger');
        try {
    ...
    route.get('/crons/:id', (0, celebrate_1.celebrate)({
        params: celebrate_1.Joi.object({
            id: celebrate_1.Joi.string().required(),
        }),
    }), async (req, res, next) => {
    ...
    route.put('/crons/status', (0, celebrate_1.celebrate)({
        body: celebrate_1.Joi.object({
